...
// Publisher can Hide some message under a given ID.
// can reveal a message under a secret by having enough votes on the specific ID.
...
// the privateShare is a secret share P(i) from some unknown Poly.
